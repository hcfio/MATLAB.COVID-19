...
% plot
subplot(1,2,1)
plot([OKNW1,TKY1,OSK1,HKD1,HYG1,JPN1],'LineWidth',2)
title('COVID-19 in Japan (total cases per 1M)','data sourced by NHK')
xlabel('date');
ylabel('cases/1M');
xticks([0 floor(D/3) floor(2*D/3) D])
xticklabels({[l0],[l1],[l2],[lf]})
legend('Okinawa','Tokyo','Osaka','Hokkaido','Hyogo','Japan','Location','northwest');
% plot
subplot(1,2,2)
plot([OKNW2,TKY2,OSK2,HKD2,HYG2,JPN2],'LineWidth',2)
