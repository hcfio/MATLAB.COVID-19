...
NSW=zeros(DD,1);
for j=1:DD
    NSW(j,1)=max(0,WNSW(j+1075,1)-WNSW(j+1068,1))/7;
end
...
VIC=zeros(DD,1);
for j=1:DD
    VIC(j,1)=max(0,WVIC(j+1075,1)-WVIC(j+1068,1))/7;
end
...
AUS=zeros(DD,1);
for j=1:DD
    AUS(j,1)=max(0,WAUS(j+1075,1)-WAUS(j+1068,1))/7;
end
...
DEAUS=zeros(DD,1);
for j=1:DD
    DEAUS(j,1)=max(0,UAUS(j+1075,1)-UAUS(j+1068,1))/7;
end
...
WAU=zeros(DD,1);
for j=1:DD
    WAU(j,1)=max(0,WWAU(j+1075,1)-WWAU(j+1068,1))/7;
end
...
DEBRA=zeros(DD,1);
for j=1:DD
    DEBRA(j,1)=max(0,UBRA(j+1075,1)-UBRA(j+1068,1))/7;
end
...
BWN=zeros(DD,1);
for j=1:DD
    BWN(j,1)=max(0,WBWN(j+1075,1)-WBWN(j+1068,1))/7;
end
UBWN=transpose(U.data(33,3:qu))/PBWN;
DEBWN=zeros(DD,1);
for j=1:DD
    DEBWN(j,1)=max(0,UBWN(j+1075,1)-UBWN(j+1068,1))/7;
end
...
HKG=zeros(DD,1);
for j=1:DD
    HKG(j,1)=max(0,WHKG(j+1075,1)-WHKG(j+1068,1))/7;
end
UHKG=transpose(U.data(72,3:qu))/PHKG;
DEHKG=zeros(DD,1);
for j=1:DD
    DEHKG(j,1)=max(0,UHKG(j+1075,1)-UHKG(j+1068,1))/7;
end
...
FIE=zeros(DD,1);
for j=1:DD
    FIE(j,1)=max(0,WFIE(j+1075,1)-WFIE(j+1068,1))/7;
end
...
DEFIE=zeros(DD,1);
for j=1:DD
    DEFIE(j,1)=max(0,UFIE(j+1075,1)-UFIE(j+1068,1))/7;
end
...
IND=zeros(DD,1);
for j=1:DD
    IND(j,1)=max(0,WIND(j+1075,1)-WIND(j+1068,1))/7;
end
UIND=transpose(U.data(149,3:qu))/PIND;
DEIND=zeros(DD,1);
for j=1:DD
    DEIND(j,1)=max(0,UIND(j+1075,1)-UIND(j+1068,1))/7;
end
...
IDN=zeros(DD,1);
for j=1:DD
    IDN(j,1)=max(0,WIDN(j+1075,1)-WIDN(j+1068,1))/7;
end
...
JPN=zeros(DD,1);
for j=1:DD
    JPN(j,1)=max(0,WJPN(j+1075,1)-WJPN(j+1068,1))/7;
end
UJPN=transpose(U.data(157,3:qu))/PJPN;
DEJPN=zeros(DD,1);
for j=1:DD
    DEJPN(j,1)=max(0,UJPN(j+1075,1)-UJPN(j+1068,1))/7;
end
...
KOR=zeros(DD,1);
for j=1:DD
    KOR(j,1)=max(0,WKOR(j+1075,1)-WKOR(j+1068,1))/7;
end
UKOR=transpose(U.data(163,3:qu))/PKOR;
DEKOR=zeros(DD,1);
for j=1:DD
    DEKOR(j,1)=max(0,UKOR(j+1075,1)-UKOR(j+1068,1))/7;
end
...
MYS=zeros(DD,1);
for j=1:DD
    MYS(j,1)=max(0,WMYS(j+1075,1)-WMYS(j+1068,1))/7;
end
UMYS=transpose(U.data(179,3:qu))/PMYS;
DEMYS=zeros(DD,1);
for j=1:DD
    DEMYS(j,1)=max(0,UMYS(j+1075,1)-UMYS(j+1068,1))/7;
end
...
DEMEX=zeros(DD,1);
for j=1:DD
    DEMEX(j,1)=max(0,UMEX(j+1075,1)-UMEX(j+1068,1))/7;
end
...
NZL=zeros(DD,1);
for j=1:DD
    NZL(j,1)=max(0,WNZL(j+1075,1)-WNZL(j+1068,1))/7;
end
...
DENZL=zeros(DD,1);
for j=1:DD
    DENZL(j,1)=max(0,XNZL(j+1075,1)-XNZL(j+1068,1))/7;
end
...
RUS=zeros(DD,1);
for j=1:DD
    RUS(j,1)=max(0,WRUS(j+1075,1)-WRUS(j+1068,1))/7;
end
URUS=transpose(U.data(222,3:qu))/PRUS;
DERUS=zeros(DD,1);
for j=1:DD
    DERUS(j,1)=max(0,URUS(j+1075,1)-URUS(j+1068,1))/7;
end
...
SIN=zeros(DD,1);
for j=1:DD
    SIN(j,1)=max(0,WSIN(j+1075,1)-WSIN(j+1068,1))/7;
end
USIN=transpose(U.data(235,3:qu))/PSIN;
DESIN=zeros(DD,1);
for j=1:DD
    DESIN(j,1)=max(0,USIN(j+1075,1)-USIN(j+1068,1))/7;
end
...
LKA=zeros(DD,1);
for j=1:DD
    LKA(j,1)=max(0,WLKA(j+1075,1)-WLKA(j+1068,1))/7;
end
ULKA=transpose(U.data(243,3:qu))/PLKA;
DELKA=zeros(DD,1);
for j=1:DD
    DELKA(j,1)=max(0,ULKA(j+1075,1)-ULKA(j+1068,1))/7;
end
...
TWN=zeros(DD,1);
for j=1:DD
    TWN(j,1)=max(0,WTWN(j+1075,1)-WTWN(j+1068,1))/7;
end
UTWN=transpose(U.data(250,3:qu))/PTWN;
DETWN=zeros(DD,1);
for j=1:DD
    DETWN(j,1)=max(0,UTWN(j+1075,1)-UTWN(j+1068,1))/7;
end
...
THA=zeros(DD,1);
for j=1:DD
    THA(j,1)=max(0,WTHA(j+1075,1)-WTHA(j+1068,1))/7;
end
UTHA=transpose(U.data(253,3:qu))/PTHA;
DETHA=zeros(DD,1);
for j=1:DD
    DETHA(j,1)=max(0,UTHA(j+1075,1)-UTHA(j+1068,1))/7;
end
...
USA=zeros(DD,1);
for j=1:DD
    USA(j,1)=max(0,WUSA(j+1075,1)-WUSA(j+1068,1))/7;
end
UUSA=transpose(U.data(261,3:qu))/PUSA;
DEUSA=zeros(DD,1);
for j=1:DD
    DEUSA(j,1)=max(0,UUSA(j+1075,1)-UUSA(j+1068,1))/7;
end
...
GBR=zeros(DD,1);
for j=1:DD
    GBR(j,1)=max(0,WGBR(j+1075,1)-WGBR(j+1068,1))/7;
end
UGBR=transpose(U.data(279,3:qu))/PGBR;
DEGBR=zeros(DD,1);
for j=1:DD
    DEGBR(j,1)=max(0,UGBR(j+1075,1)-UGBR(j+1068,1))/7;
end
...
VNM=zeros(DD,1);
for j=1:DD
    VNM(j,1)=max(0,WVNM(j+1075,1)-WVNM(j+1068,1))/7;
end
...
OKNW=zeros(DD,1);
for j=1:DD
    OKNW(j,1)=(OKNW1(j+967,1)-OKNW1(j+960,1))/7;
end
DEOKNW=zeros(DD,1);
for j=1:DD
    DEOKNW(j,1)=(OKNW2(j+967,1)-OKNW2(j+960,1))/7;
end
...
TKY=zeros(DD,1);
for j=1:DD
    TKY(j,1)=(TKY1(j+967,1)-TKY1(j+960,1))/7;
end
DETKY=zeros(DD,1);
for j=1:DD
    DETKY(j,1)=(TKY2(j+967,1)-TKY2(j+960,1))/7;
end
...
OSK=zeros(DD,1);
for j=1:DD
    OSK(j,1)=(OSK1(j+967,1)-OSK1(j+960,1))/7;
end
DEOSK=zeros(DD,1);
for j=1:DD
    DEOSK(j,1)=(OSK2(j+967,1)-OSK2(j+960,1))/7;
end
...
HKD=zeros(DD,1);
for j=1:DD
    HKD(j,1)=(HKD1(j+967,1)-HKD1(j+960,1))/7;
end
DEHKD=zeros(DD,1);
for j=1:DD
    DEHKD(j,1)=(HKD2(j+967,1)-HKD2(j+960,1))/7;
end
